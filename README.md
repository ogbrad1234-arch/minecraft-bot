*NodejsBot: Your Smart AFK Bot for Minecraft Java/Bedrock* 
So I built *mc-bot* - a smart AFK bot that keeps your free-plan server alive 24/7 without you babysitting it.  
server will not detect the bot, when the bot join your server
*What it does:*  
...
- *Chat commands*: auto /register and /login
